			...
			<div class="container">
				...
				<div class="row">
					...
					<fieldset class="scheduler-border">
						...
						<img src="./Upload/${m.filename}" class="img-responsive">
						</div>
						...
						<div class="col-md-12">
							<a href="memo.delete.do?idx=${m.idx}"><i
								class="fa fa-2x fa-fw fa-trash-o"></i></a> 
							<a	href="memo.edit.do?idx=${m.idx}"><i class="fa fa-2x fa-edit fa-fw"></i></a>
							<a><i class="fa fa-2x fa-fw fa-heart"></i></a>
							 <a><i class="fa fa-2x fa-fw hub fa-thumbs-down"></i></a>
						</div>
						</fieldset>
					</div>
					<c:if test="${st.index mod 3 ==2 }">
						</div><!--row end  -->
			...
			${totalCount}
				<ul class="pagination">
					...
					<c:forEach var="i" begin="1" end="${pageCount}">
					    <li><a href="memo.list.do?cpage=${i}">${i}</a></li> 
					</c:forEach>
					<li><a href="#">Next</a></li>
				</ul>
			</div>
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-xs-2 col-xs-offset-2 text-center">
						<a href="memo.list.do"><i class="fa fa-3x fa-align-justify fa-fw"></i></a>
					</div>
					<div class="col-xs-2">
						<a href="memo.do"><i class="-square fa fa-3x fa-fw fa-pencil"></i></a>
					</div>
					<div class="col-xs-2">
