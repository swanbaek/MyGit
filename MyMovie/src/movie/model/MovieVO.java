...
public class MovieVO implements java.io.Serializable {
	...
	public MovieVO(Integer movie_code, String movie_title, Integer genrecode, Integer gradecode, String director,
			String story, Integer runtime, Date opendate, String poster1, String poster2, String actor, String producer,
			String makeYear, String makeCountry, String supplier, Integer release_status, String movie_site, String subtitle) {
		super();
